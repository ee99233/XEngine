...
public:
	...
	void CreateSphere(INT r,UINT m, UINT n, OUT vector<XVertx4> &invertxs, OUT vector<UINT>& inindex);
	void CreateBox(float w, float h, float d, OUT vector<XVertx4> &invertxs, OUT vector<UINT>& inindex);
private:
